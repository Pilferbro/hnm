 ...
 */
@Service
public class Tflow030Service extends TXBaseService {
    private static final Log logger = LogFactory.getLog(Tflow030Service.class);
    ...
    public Object doService(Map<String, Object> env, Map<String, Object> p) {
        ...
        if (userRole == 0) {
            ...
            throw new BusinessException("Tflow030ServiceException", "登陆人员未配置角色");
        }
        if (userRole != 1) {
            p.put("gt_approval_user", userId);
        }
        ...
        List<Map<String, Object>> result = tApprovalDao.queryForConnectListBycondition2(delkong(p));
        ...
        logger.info("Tflow030Service执行完成");
        return typeRuslt;
    }
