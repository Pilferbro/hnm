...
@Service
public class Operate16 implements Inspection1JobStrategy {
            ...
            for (Map<String, Object> map1 : list1) {
                ...
                if (list2 != null && list2.size() > 0) {
                    ...
                    if (now_date.compareTo(month_date) > 0) {
                        ...
                        //交易笔数
                        long tNum = Long.parseLong(numList.get(1));
                        ...
                        if (compareTo(format, numList.get(0)) > 0) {
                            site_list.add(map1);
                        }
                    }
                } else {
    ...
    //获取n月前的第一天
    private String getOverMonth(String update_time, int operateTime) {

        Date date = DateUtils.addMonth(DateUtil.parse(update_time, "yyyy-MM-dd HH:mm:ss"), operateTime);
