...
/**
 * 自动化工具生成数据库操作类
 * 表名:SYS_ROLE_MOBILE_MENU
 * 主键:
 * menu_code
 * role_id
 **/
@Repository
public class SysRoleMobileMenuDao extends TXBaseDao {
	...
	public int save(Map<String, Object> p) {
		String sql = Sql.create("insert into SYS_ROLE_MOBILE_MENU (")
	...
	public int deleteByPk(Map<String, Object> p) {
		String sql = Sql.create("delete from SYS_ROLE_MOBILE_MENU where 1=1 ")
	...
	public int updateByPk(Map<String, Object> p) {
		String sql = Sql.create("update SYS_ROLE_MOBILE_MENU set ")
	...
	public List<Map<String, Object>> queryForList(Map<String, Object> p) {
		String sql = Sql.create("select * from SYS_ROLE_MOBILE_MENU where 1=1")
				.append(and("role_id = :role_id", hasKey(p, "role_id")))
				.append(and("menu_code = :menu_code", hasKey(p, "menu_code")))
				.append(orderBySql())
				.toString();
	...
	public List<Map<String, Object>> queryForListByPage(Map<String, Object> p) {
		Sql sql = Sql.create("select * from SYS_ROLE_MOBILE_MENU where 1=1")
				.append(and("role_id = :role_id", hasKey(p, "role_id")))
				.append(and("menu_code = :menu_code", hasKey(p, "menu_code")));
	...
	public long count(Map<String, Object> p) {
		String sql = Sql.create("select count(*) from SYS_ROLE_MOBILE_MENU where 1=1 ")
				.append(and("role_id = :role_id", hasKey(p, "role_id")))
				.append(and("menu_code = :menu_code", hasKey(p, "menu_code")))
				.toString();
		printSql(sql, p);
	...
	public int[] saveList(List<Map<String,Object>> paramlist) {
			...
			Sql sql= Sql.create("");
			sql.append("insert into SYS_ROLE_MOBILE_MENU (")
				.append(field("role_id "))
				.append(field("menu_code "))
			.append(") values (")
				.append(field(":role_id "))
	...
	public int deleteMenuFromRole(Map<String, Object> p) {
		String sql = "delete from SYS_ROLE_MOBILE_MENU where menu_code = :menu_code";
		printSql(sql,p);
		return delete(sql,p);
	}
}
