 ...
 */
@Service
public class Tflow023Service extends TXBaseService {
    private static final Log logger = LogFactory.getLog(Tflow023Service.class);
    ...
    public Object doService(Map<String, Object> env, Map<String, Object> p) {
        ...
        List<Map<String, Object>> result = tApprovalDao.queryForListBycondition2(delkong(p));
        ...
        logger.info("Tflow023Service执行完成");
        return typeRuslt;
    }
