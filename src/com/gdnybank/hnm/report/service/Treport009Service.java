 ...
 */
@Service
public class Treport009Service extends TXBaseService{
	private static final Log logger = LogFactory.getLog(Treport009Service.class);
	...
	public Object doService(Map<String, Object> env, Map<String, Object> p) {
        ...
        if (ObjectUtil.isEmpty(p.get("query_org"))) {
            ...
            throw new BusinessException("Treport009ServiceException", "query_org为必传字段");
        }
