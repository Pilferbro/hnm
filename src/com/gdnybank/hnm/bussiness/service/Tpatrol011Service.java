...
@Service
@Transactional
public class Tpatrol011Service extends TXBaseService {
    ...
    public Object doService(Map<String, Object> evn, Map<String, Object> p) {
        ...
        try {
            ...
            if (userRoleLevel == 0) {
                ...
                throw new BusinessException("Tpatrol011ServiceException", "登陆人员未配置角色");
            }
            ...
            if (ObjectUtil.isNotEmpty(p.get("export"))) {
                ...
                resultList = hPatrolLogContentDao.queryByPage(delkong(p));
            }
            ...
            throw new BusinessException("Tpatrol011ServiceException", "查询失败");
        }
