 ...
 **/
@Repository
public class SendMsgLogDao extends TXBaseDao{

	/**当前所有字段名**/
	String[] fieldNames=new String[]{"id","account_id","account_name","phone","sms_tpl","send_flag","create_time","update_time"};
	/**当前主键(包括多主键)**/
	String[] primaryKeys=new String[]{"id"};

	@Override
	public int save(Map<String,Object> p) {
				//p.put("id",sequenceService.getTableFlowNo("SEND_MSG_LOG", "id"));
		String sql=Sql.create("insert into SEND_MSG_LOG (")
				.append(field("id "))
				.append(field("account_id ",hasKey(p,"account_id")))
				.append(field("account_name ",hasKey(p,"account_name")))
				.append(field("phone ",hasKey(p,"phone")))
				.append(field("sms_tpl ",hasKey(p,"sms_tpl")))
				.append(field("send_flag ",hasKey(p,"send_flag")))
	...
	public int deleteByPk(Map<String,Object> p) {
		String sql=Sql.create("delete from SEND_MSG_LOG where 1=1 ")
				.append(and("id = :id"))
				.toString();
		 printSql(sql,p);
		return delete(sql, p);
	...
	public int delete(Map<String,Object> p) {
		...
		String sql=Sql.create("delete from SEND_MSG_LOG where 1=1 ")
				...
				.append(and("account_name = :account_name",hasKey(p,"account_name")))
				.append(and("phone = :phone",hasKey(p,"phone")))
				.append(and("sms_tpl = :sms_tpl",hasKey(p,"sms_tpl")))
				.append(and("send_flag = :send_flag",hasKey(p,"send_flag")))
	...
	public int updateByPk(Map<String,Object> p) {
		String sql=Sql.create("update SEND_MSG_LOG set ")
				.append(field("account_id = :account_id",hasKey(p,"account_id")))
				.append(field("account_name = :account_name",hasKey(p,"account_name")))
				.append(field("phone = :phone",hasKey(p,"phone")))
				.append(field("sms_tpl = :sms_tpl",hasKey(p,"sms_tpl")))
				.append(field("send_flag = :send_flag",hasKey(p,"send_flag")))
	...
	public List<Map<String, Object>> queryForList(Map<String,Object> p) {
		String sql=Sql.create("select * from SEND_MSG_LOG where 1=1")
				.append(and("id = :id",hasKey(p,"id")))
				.append(and("account_id = :account_id",hasKey(p,"account_id")))
				.append(and("account_name = :account_name",hasKey(p,"account_name")))
				.append(and("phone = :phone",hasKey(p,"phone")))
	...
	public List<Map<String, Object>> queryForListByPage(Map<String,Object> p) {
		Sql sql=Sql.create("select * from SEND_MSG_LOG where 1=1")
			.append(and("id = :id",hasKey(p,"id")))
						.append(and("account_id = :account_id",hasKey(p,"account_id")))
						.append(and("account_name = :account_name",hasKey(p,"account_name")))
						.append(and("phone = :phone",hasKey(p,"phone")))
	...
	public long count(Map<String,Object> p) {
		String sql = Sql.create("select count(*) from SEND_MSG_LOG where 1=1 ")
				.append(and("id = :id",hasKey(p,"id")))
				.append(and("account_id = :account_id",hasKey(p,"account_id")))
				.append(and("account_name = :account_name",hasKey(p,"account_name")))
				.append(and("phone = :phone",hasKey(p,"phone")))
