 ...
 **/
@Repository
public class TXgDataHisDao extends TXBaseDao{
	...
	public int save(Map<String,Object> p) {
				p.put("id",sequenceService.getTableFlowNo("T_XG_DATA_HIS", "id"));
		String sql=Sql.create("insert into T_XG_DATA_HIS (")
				.append(field("id "))
	...
	public int deleteByPk(Map<String,Object> p) {
		String sql=Sql.create("delete from T_XG_DATA_HIS where 1=1 ")
				.append(and("id = :id"))
				.toString();
		 printSql(sql,p);
		return delete(sql, p);
	...
	public int updateByPk(Map<String,Object> p) {
		String sql=Sql.create("update T_XG_DATA_HIS set ")
	...
	public List<Map<String, Object>> queryForList(Map<String,Object> p) {
		String sql=Sql.create("select * from T_XG_DATA_HIS where 1=1")
				.append(and("id = :id",hasKey(p,"id")))
				.append(and("create_date = :create_date",hasKey(p,"create_date")))
				.append(and("create_time = :create_time",hasKey(p,"create_time")))
				.append(and("data_name = :data_name",hasKey(p,"data_name")))
	...
	public List<Map<String, Object>> queryForListByPage(Map<String,Object> p) {
		Sql sql=Sql.create("select * from T_XG_DATA_HIS where 1=1")
			.append(and("id = :id",hasKey(p,"id")))
						.append(and("create_date = :create_date",hasKey(p,"create_date")))
						.append(and("create_time = :create_time",hasKey(p,"create_time")))
						.append(and("data_name = :data_name",hasKey(p,"data_name")))
	...
	public long count(Map<String,Object> p) {
		String sql = Sql.create("select count(*) from T_XG_DATA_HIS where 1=1 ")
				.append(and("id = :id",hasKey(p,"id")))
				.append(and("create_date = :create_date",hasKey(p,"create_date")))
				.append(and("create_time = :create_time",hasKey(p,"create_time")))
				.append(and("data_name = :data_name",hasKey(p,"data_name")))
	...
	public List<Map<String, Object>> queryForListMaxCreateDate(Map<String,Object> p) {
		String sql=Sql.create("select Max(create_date) max_date from T_XG_DATA_HIS where 1=1")
				.append(and("id = :id",hasKey(p,"id")))
				.append(and("create_date = :create_date",hasKey(p,"create_date")))
				.append(and("create_time = :create_time",hasKey(p,"create_time")))
				.append(and("data_name = :data_name",hasKey(p,"data_name")))
