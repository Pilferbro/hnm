 ...
 **/
@Repository
public class TVoucherFlowDao extends TXBaseDao{

	/**当前所有字段名**/
	String[] fieldNames=new String[]{"id","tsdt","site_no","f011","prid","file_ids","voucher_result","create_time","update_time","creator"};
	/**当前主键(包括多主键)**/
	String[] primaryKeys=new String[]{"id"};

	@Override
	public int save(Map<String,Object> p) {
				//p.put("id",sequenceService.getTableFlowNo("T_VOUCHER_FLOW", "id"));
		String sql=Sql.create("insert into T_VOUCHER_FLOW (")
				.append(field("id "))
				...
				.append(field("voucher_result ",hasKey(p,"voucher_result")))
	...
	public int deleteByPk(Map<String,Object> p) {
		String sql=Sql.create("delete from T_VOUCHER_FLOW where 1=1 ")
				.append(and("id = :id"))
				.toString();
		 printSql(sql,p);
		return delete(sql, p);
	...
	public int delete(Map<String,Object> p) {
		...
		String sql=Sql.create("delete from T_VOUCHER_FLOW where 1=1 ")
				...
				.append(and("voucher_result = :voucher_result",hasKey(p,"voucher_result")))
	...
	public int updateByPk(Map<String,Object> p) {
		String sql=Sql.create("update T_VOUCHER_FLOW set ")
				...
				.append(field("voucher_result = :voucher_result",hasKey(p,"voucher_result")))
	...
	public List<Map<String, Object>> queryForList(Map<String,Object> p) {
		String sql=Sql.create("select t1.* from T_VOUCHER_FLOW t1 where 1=1")
				...
				.append(and("t1.file_ids = :file_ids",hasKey(p,"file_ids")))
				.append(and("t1.voucher_result = :voucher_result",hasKey(p,"voucher_result")))
	...
	public List<Map<String, Object>> queryForListByPage(Map<String,Object> p) {
		Sql sql=Sql.create("select * from T_VOUCHER_FLOW where 1=1")
			.append(and("id = :id",hasKey(p,"id")))
						.append(and("tsdt = :tsdt",hasKey(p,"tsdt")))
						.append(and("site_no = :site_no",hasKey(p,"site_no")))
						.append(and("f011 = :f011",hasKey(p,"f011")))
	...
	public Map<String, Object> queryForMap(Map<String,Object> p) {
		String sql=Sql.create("select * from T_VOUCHER_FLOW where 1=1 ")
				.append(and("id = :id",hasKey(p,"id")))
				.append(and("tsdt = :tsdt",hasKey(p,"tsdt")))
				.append(and("site_no = :site_no",hasKey(p,"site_no")))
				.append(and("f011 = :f011",hasKey(p,"f011")))
	...
	public long count(Map<String,Object> p) {
		String sql = Sql.create("select count(*) from T_VOUCHER_FLOW where 1=1 ")
				.append(and("id = :id",hasKey(p,"id")))
				.append(and("tsdt = :tsdt",hasKey(p,"tsdt")))
				.append(and("site_no = :site_no",hasKey(p,"site_no")))
				.append(and("f011 = :f011",hasKey(p,"f011")))
