 ...
 */
@Service
public class Tflow029Service extends TXBaseService {
    private static final Log logger = LogFactory.getLog(Tflow029Service.class);
    ...
    public Object doService(Map<String, Object> env, Map<String, Object> p) {
        ...
        if (userRole == 0) {
            ...
            throw new BusinessException("Tflow029ServiceException", "登陆人员未配置角色");
        }
        if (userRole != 1) {
            add(userId, p, "gt_approval_user");
        }
        ...
        List<Map<String, Object>> result = tApprovalDao.queryForConnectListBycondition1(delkong(p));
        ...
        typeRuslt.put("approvalConnectList", result);

        logger.info("Tflow029Service执行完成");
        return typeRuslt;
    }
