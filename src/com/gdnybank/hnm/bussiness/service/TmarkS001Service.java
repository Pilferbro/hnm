...
import com.gdnybank.hnm.pub.dao.HMarkSheelDao;
 ...
 */
@Service
public class TmarkS001Service extends TXBaseService {

    private static final Logger logger = LoggerFactory.getLogger(TmarkS001Service.class);

    @Autowired
    HMarkSheelDao markSheelDao;
    ...
    public Object doService(Map<String, Object> env, Map<String, Object> p) {
        ...
        try{
            ...
            //查询三级
            parms.put("mlevel","3");
            List<Map<String, Object>> pointMap =  markSheelDao.queryForList(parms);

            groupMap(contmap,pointMap);
            groupMap(projmap,contmap);
            resultMap.put("markSheelList",projmap);
            return resultMap;
        }catch (Exception e){
            logger.info("查询评分表失败",e);
            throw new BusinessException("TmarkS001ServiceException", "查询评分表失败");
        }
