...
@Service
@Transactional
public class Tpatrol008Service extends TXBaseService {
    ...
    public Object doService(Map<String, Object> map, Map<String, Object> p) {
        ...
        try {
            ...
            if (userRoleLevel == 0) {
                ...
                throw new BusinessException("Tpatrol008ServiceException", "登陆人员未配置角色");
            }
            ...
            //分页信息
            setPageInfo(p);
            List<Map<String, Object>> resultList = hPatrolLogContentDao.queryForListByPage(delkong(p));
...
//                //进行判断
//                return ((String) o2.get("created")).compareTo((String) o1.get("created"));
//            });
            ...
            throw new BusinessException("Tpatrol008ServiceException", "查询风险列表失败");
        }
