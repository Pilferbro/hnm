 ...
 **/
@Repository
public class HPatrolLogDao extends TXBaseDao{

	/**当前所有字段名**/
	String[] fieldNames=new String[]{"log_id","patrol_id","patrol_content","patrol_result"};
	/**当前主键(包括多主键)**/
	String[] primaryKeys=new String[]{};

	@Override
	public int save(Map<String,Object> p) {
		String sql=Sql.create("insert into H_PATROL_LOG (")
				.append(field("log_id ",hasKey(p,"log_id")))
				.append(field("patrol_id ",hasKey(p,"patrol_id")))
				.append(field("patrol_content ",hasKey(p,"patrol_content")))
				.append(field("patrol_result ",hasKey(p,"patrol_result")))
				.append(") values (")
				.append(field(":log_id ",hasKey(p,"log_id")))
				.append(field(":patrol_id ",hasKey(p,"patrol_id")))
				.append(field(":patrol_content ",hasKey(p,"patrol_content")))
	...
	public int deleteByPk(Map<String,Object> p) {
		String sql=Sql.create("delete from H_PATROL_LOG where 1=1 ")
				.append(and("log_id = :log_id"))
				.toString();
		 printSql(sql,p);
		return delete(sql, p);
	}
	...
	public int delete(Map<String,Object> p) {
		...
		String sql=Sql.create("delete from H_PATROL_LOG where 1=1 ")
				.append(and("log_id = :log_id",hasKey(p,"log_id")))
				.append(and("patrol_id = :patrol_id",hasKey(p,"patrol_id")))
				.append(and("patrol_content = :patrol_content",hasKey(p,"patrol_content")))
				.append(and("patrol_result = :patrol_result",hasKey(p,"patrol_result")))
				.toString();
		 printSql(sql,p);
		return delete(sql, p);
	}
	...
	public int updateByPk(Map<String,Object> p) {
		String sql=Sql.create("update H_PATROL_LOG set ")
				.append(field("patrol_id = :patrol_id",hasKey(p,"patrol_id")))
				.append(field("patrol_content = :patrol_content",hasKey(p,"patrol_content")))
				.append(field("patrol_result = :patrol_result",hasKey(p,"patrol_result")))
				.append(" where 1=1 ")
				.append(and("log_id = :log_id"))
				.toString();
		printSql(sql,p);
	...
	public int update(Map<String,Object> p) {
		checkParameter(p,primaryKeys,fieldNames);
		String sql=Sql.create("update H_PATROL_LOG set ")
				.append(field("log_id = :log_id",hasKey(p,"log_id")))
				.append(field("patrol_id = :patrol_id",hasKey(p,"patrol_id")))
				.append(field("patrol_content = :patrol_content",hasKey(p,"patrol_content")))
				.append(field("patrol_result = :patrol_result",hasKey(p,"patrol_result")))
				.append(" where 1=1 ")
	...
	public List<Map<String, Object>> queryForList(Map<String,Object> p) {
		String sql=Sql.create("select * from H_PATROL_LOG where 1=1")
				.append(and("log_id = :log_id",hasKey(p,"log_id")))
				.append(and("patrol_id = :patrol_id",hasKey(p,"patrol_id")))
				.append(and("patrol_content = :patrol_content",hasKey(p,"patrol_content")))
				.append(and("patrol_result = :patrol_result",hasKey(p,"patrol_result")))
	...
	public List<Map<String, Object>> queryForListByPage(Map<String,Object> p) {
		Sql sql=Sql.create("select * from H_PATROL_LOG where 1=1")
			.append(and("log_id = :log_id",hasKey(p,"log_id")))
						.append(and("patrol_id = :patrol_id",hasKey(p,"patrol_id")))
						.append(and("patrol_content = :patrol_content",hasKey(p,"patrol_content")))
						.append(and("patrol_result = :patrol_result",hasKey(p,"patrol_result")))
	...
	public long count(Map<String,Object> p) {
		String sql = Sql.create("select count(*) from H_PATROL_LOG where 1=1 ")
				.append(and("log_id = :log_id",hasKey(p,"log_id")))
				.append(and("patrol_id = :patrol_id",hasKey(p,"patrol_id")))
				.append(and("patrol_content = :patrol_content",hasKey(p,"patrol_content")))
				.append(and("patrol_result = :patrol_result",hasKey(p,"patrol_result")))
	...
	public List<Map<String, Object>> queryForListById(Map<String, Object> p) {
		...
		String sql=Sql.create("select patrol_result from H_PATROL_LOG where patrol_id = :patrol_id " +
				"and patrol_content = '90101'")
				.toString();
		printSql(sql,p);
		return queryForList(sql, p);
	}

	public List<Map<String, Object>> queryPatrolResult(Map<String, Object> p) {

		String sql=Sql.create("select patrol_content,patrol_result from H_PATROL_LOG where 1=1")
				.append(and("log_id = :log_id",hasKey(p,"log_id")))
				.append(and("patrol_id = :patrol_id",hasKey(p,"patrol_id")))
				.append(and("patrol_content = :patrol_content",hasKey(p,"patrol_content")))
				.append(and("patrol_result = :patrol_result",hasKey(p,"patrol_result")))
